#### Mup without docker dependency

Muplite is a command line tool that allows you to deploy any [Meteor](http://meteor.com) app to your own server. It currently supports Ubuntu.

This repository formerly was at `frankliu/muplite`.

You can install and use `muplite` on Linux, Mac and Windows.
